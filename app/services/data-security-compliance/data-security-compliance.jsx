  ...
  const exploreServices = [
    {
      ...
      href: "/services/saas",
      description:
        "Blend secure architectures with shipping velocity from day one.",
    ...
    },
    {
      ...
      description:
        "Equip success teams to translate security into customer confidence.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Showcase compliance readiness during market-launch moments.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Align security messaging with demand generation narratives.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          <motion.h1
            className="text-4xl lg:pl-32 mb-2 mt-12 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:mt-10 lg:pr-[50px] text-center lg:text-left"
          ...
          <motion.p
            className="max-w-2xl lg:pl-32 text-gray-200 pr-0 text-center  lg:text-left lg:pr-[50px]"
            initial={ { opacity: 0 } }
            animate={ { opacity: 1 } }
