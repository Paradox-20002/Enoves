  ...
  const featureSections = [
    {
      ...
      image: { src: "/images/marketing-strategy_images/marketing1.jpg", alt: "Marketing strategy workshop" },
    ...
    },
    {
      ...
      image: { src: "/images/marketing-strategy_images/marketing2.jpg", alt: "Revenue alignment session" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Sparkles className="w-6 h-6" />, title: "Analytics Outreach", href: "/services/analytics-outreach", description: "Layer attribution and insight loops onto every campaign motion.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Email Marketing", href: "/services/email-marketing", description: "Operationalise strategy through lifecycle journeys that convert.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Paid Media", href: "/services/paid-media", description: "Amplify priority campaigns with performance-driven distribution.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Palette className="w-6 h-6" />, title: "Branding", href: "/services/branding", description: "Ensure every initiative expresses a cohesive, memorable narrative.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/marketing-strategy_images/marketing3.jpeg" alt="Strategic planning board" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
