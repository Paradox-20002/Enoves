...
import { graphicsFaqs } from "./graphics-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Design asset suites tailored to every launch. We translate strategy decks into scroll-stopping visuals for social, paid, and nurture channels that stay aligned with brand systems.",
      highlights: [
        { label: "Concept Boards", color: "bg-sky-400" },
        { label: "Channel Adaptations", color: "bg-cyan-400", delay: "0.3s" },
        { label: "Performance Feedback", color: "bg-blue-400", delay: "0.6s" },
      ],
      image: { src: "/images/graphics_images/graphic4.jpg", alt: "Graphic designers collaborating" },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Systems & Templates",
      description:
        "Build reusable design kits so teams can work faster. We deliver editable templates, illustration libraries, and export presets that keep day-to-day production consistent and efficient.",
      highlights: [
        { label: "Template Libraries", color: "bg-purple-400" },
        { label: "Illustration Sets", color: "bg-violet-400", delay: "0.3s" },
        { label: "Handoff Guides", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: { src: "/images/graphics_images/graphic2.jpg", alt: "Design system templates" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Palette className="w-6 h-6" />, title: "Branding", href: "/services/branding", description: "Identity foundations that inform every graphic treatment.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Sparkles className="w-6 h-6" />, title: "Product Design", href: "/services/product-design", description: "Interface design that blends visuals with high-performing UX.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Email Marketing", href: "/services/email-marketing", description: "Lifecycle campaigns enriched with bespoke imagery and layouts.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Digital Marketing", href: "/services/digital-marketing", description: "Performance programs powered by on-brand creative variations.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/graphics_images/graphic3.jpg" alt="Graphic design studio" fill priority className="object-cover object-center" sizes="100vw"/>
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] lg:text-5xl font-bold mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Deliver Visuals That Keep Every Launch On-Brand
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves partners with growth and creative teams to concept, iterate, and ship graphics that fuel campaigns while preserving the craft your brand deserves.
          </motion.p>
