  ...
  const featureSections = [
    {
      ...
      image: {
        src: "/images/graphics_images/graphic4.jpg",
    ...
    },
    {
      ...
      image: {
        src: "/images/graphics_images/graphic2.jpg",
  ...
  const exploreServices = [
    {
      ...
      description: "Identity foundations that inform every graphic treatment.",
    ...
    },
    {
      ...
      description:
        "Interface design that blends visuals with high-performing UX.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Lifecycle campaigns enriched with bespoke imagery and layouts.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Performance programs powered by on-brand creative variations.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/graphics_images/graphic3.jpg"
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          >
            Enoves partners with growth and creative teams to concept, iterate,
            and ship graphics that fuel campaigns while preserving the craft
            your brand deserves.
          </motion.p>
