  ...
  const featureSections = [
    {
      ...
      image: {
        src: "/images/paid-media_images/paid1.jpg",
        alt: "Paid media planning workshop",
      },
    ...
    },
    {
      ...
      image: {
        src: "/images/paid-media_images/paid3.jpg",
  ...
  const exploreServices = [
    {
      ...
      description:
        "Connect paid performance insights to cross-channel roadmaps.",
    ...
    },
    {
      ...
      description:
        "Convert paid demand with lifecycle sequences that sustain momentum.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Instrument attribution loops that surface the metrics that matter.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Deploy on-brand variations fast to fuel creative experimentation.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          >
            Enoves embeds paid media strategists who unite creative, data, and
            optimisation to scale acquisition without sacrificing efficiency or
            insight.
          </motion.p>
