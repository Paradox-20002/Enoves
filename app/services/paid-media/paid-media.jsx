...
import { paidMediaFaqs } from "./paid-media-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Design full-funnel campaign structures that balance prospecting, retargeting, and retention. We orchestrate audiences, placements, and creative angles around your revenue targets.",
      highlights: [
        { label: "Audience Mapping", color: "bg-pink-400" },
        { label: "Offer Positioning", color: "bg-fuchsia-400", delay: "0.3s" },
        { label: "Budget Modeling", color: "bg-rose-400", delay: "0.6s" },
      ],
      image: { src: "/images/paid-media_images/paid1.jpg", alt: "Paid media planning workshop" },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Optimisation Engine",
      description:
        "Run a continuous test-and-learn loop across creative, bids, and landing experiences. We translate insights into weekly roadmaps that compound ROAS and pipeline contribution.",
      highlights: [
        { label: "Creative Testing", color: "bg-purple-400" },
        { label: "Bid Automation", color: "bg-violet-400", delay: "0.3s" },
        { label: "Conversion QA", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: { src: "/images/paid-media_images/paid3.jpg", alt: "Campaign analytics dashboard" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Sparkles className="w-6 h-6" />, title: "Marketing Strategy", href: "/services/marketing-strategy", description: "Connect paid performance insights to cross-channel roadmaps.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Email Marketing", href: "/services/email-marketing", description: "Convert paid demand with lifecycle sequences that sustain momentum.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Analytics Outreach", href: "/services/analytics-outreach", description: "Instrument attribution loops that surface the metrics that matter.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Palette className="w-6 h-6" />, title: "Graphics", href: "/services/graphics", description: "Deploy on-brand variations fast to fuel creative experimentation.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/paid-media_images/paid4.jpg" alt="Paid media analysts working" fill priority className="object-cover object-center" sizes="100vw"/>
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] lg:text-5xl font-bold mb-2 mt-12 text-center lg:text-left bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent lg:pl-18" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Turn Every Dollar Of Ad Spend Into Measurable Growth
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves embeds paid media strategists who unite creative, data, and optimisation to scale acquisition without sacrificing efficiency or insight.
          </motion.p>
