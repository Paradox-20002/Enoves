    ...
    >
      ...
      >
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          <motion.h1
            className="text-4xl mb-2 lg:pl-32 mt-12 bg-gradient-to-r from-white via-purple-200 to-white text-center lg:text-left bg-clip-text text-transparent digital-hero-title lg:mt-10 lg:pr-[300px]"
          ...
          >
            Enoves builds mobile experiences with discovery-to-growth squads. We
            combine human-centred design, resilient engineering, and analytics
            that fuel iteration.
          </motion.p>
      ...
      >
        <h1 className="text-2xl md:text-3xl text-white font-extrabold">
          Launch with cross-functional mobile experts
        </h1>
        <p className="text-gray-300 text-base md:text-lg mb-12 max-w-2xl mt-4">
          Partner with designers, engineers, and strategists dedicated to
          building mobile experiences that meet user expectations and business
          outcomes.
        </p>
        <Link href="/contact">
          <motion.button
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Connect your mobile product with web platforms, secure
                infrastructure, and the talent to keep shipping.
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium uppercase tracking-[0.22em] text-fuchsia-200/70">
                        { icon }
                      </span>
                      <motion.span
