...
import { Sparkles, Cpu, Layers, Users } from "lucide-react";
  ...
  const featureSections = [
    {
      ...
      description:
        "Validate ideas quickly with collaborative strategy, user research, and rapid prototyping. We shape MVP scope, experience flows, and technical spikes before code begins.",
      highlights: [
        { label: "Journey Mapping", color: "bg-pink-400" },
        { label: "Prototype Sprints", color: "bg-rose-400", delay: "0.3s" },
        { label: "Tech Evaluations", color: "bg-fuchsia-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/appdev_images/appdev1.png",
        alt: "Product team reviewing app wireframes",
      },
    ...
    },
    {
      ...
      description:
        "Launch and scale with native and cross-platform squads. We embed automation, analytics, and release workflows that keep mobile experiences performing at every stage.",
      highlights: [
        { label: "Native & Cross-Platform", color: "bg-purple-400" },
        { label: "CI/CD Automation", color: "bg-violet-400", delay: "0.3s" },
        { label: "Growth Experiments", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/appdev_images/appdev2.webp",
        alt: "Developers monitoring mobile analytics dashboard",
      },
  ...
  const exploreServices = [
    {
      ...
      description:
        "Build headless, performant web ecosystems to match your app.",
    ...
    },
    {
      ...
      description:
        "Connect product experiences with bespoke backend platforms.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Protect user data with compliant architectures and processes.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Add mobile specialists that blend into your delivery rituals.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8"
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/appdev_images/appdev5.jpg" alt="Mobile team collaborating on app launch" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] font-bold lg:text-5xl mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18"
            initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Launch Mobile Products Your Users Rely On Every Day
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left"
            ...
            Enoves builds mobile experiences with discovery-to-growth squads. We combine human-centred design, resilient engineering, and analytics that fuel iteration.
          </motion.p>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Connect your mobile product with web platforms, secure infrastructure, and the talent to keep shipping.
              </p>
            </div>
          </div>
      ...
      {/* FAQ */}
      <FaqSection faqs={appDevelopmentFaqs} />
