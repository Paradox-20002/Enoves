    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/custom_images/custom1.png"
            alt="Custom software workflow dashboard"
            fill
            priority
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          <motion.h1
            className="text-4xl lg:pl-32 mb-2 mt-12 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:mt-10 lg:pr-[300px] text-center lg:text-left"
          ...
          >
            Enoves builds resilient platforms tailored to your workflows. From
            discovery to launch, we ensure every release is measurable, secure,
      ...
      >
        <h1 className="text-2xl md:text-3xl text-white font-extrabold">
          Build software that keeps pace with change
        </h1>
        <p className="text-gray-300 text-base md:text-lg mb-12 max-w-2xl mt-4">
          From greenfield platforms to modernising enterprise systems, our teams
          orchestrate delivery that stays aligned with your goals and your
          customers.
        </p>
        <Link href="/contact">
          <motion.button
      ...
      <section className="relative mx-auto max-w-6xl w-full px-6">
        ...
        <div className="relative z-10 flex flex-col gap-6">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.28em] text-emerald-200/80">
                Discover
              </span>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Pair bespoke software with mobile apps, secure infrastructure,
                and elastic delivery teams that sustain momentum.
              </p>
            </div>
          </div>
