...
import { Sparkles, Workflow, Database, Users } from "lucide-react";
import { motion } from "framer-motion";
import { customSoftwareFaqs } from "./custom-software-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Transform legacy systems into modular, API-driven platforms. We refactor critical workflows, retire technical debt, and deploy architectures built for agility.",
      highlights: [
        { label: "Legacy Refactors", color: "bg-emerald-400" },
        { label: "Service Design", color: "bg-teal-400", delay: "0.3s" },
        { label: "Automation Audits", color: "bg-green-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/custom_images/custom2.png",
        alt: "Developers mapping software architecture",
      },
    ...
    },
    {
      ...
      description:
        "Launch bespoke software with cross-functional pods covering product, engineering, and data. We integrate with your teams to deliver roadmap milestones faster.",
      highlights: [
        { label: "Roadmap Delivery", color: "bg-purple-400" },
        { label: "Data Pipelines", color: "bg-violet-400", delay: "0.3s" },
        { label: "Quality Ops", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/custom_images/custom3.png",
        alt: "Product squad planning delivery schedule",
      },
  ...
  const exploreServices = [
    {
      ...
      description: "Extend custom platforms to engaging web experiences.",
    ...
    },
    {
      ...
      description: "Bring your platform to life on mobile and cross-platform.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Embed compliance and governance into every release.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Scale squads with senior specialists on demand.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];

  return (
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8"
      style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/custom_images/custom1.png" alt="Custom software workflow dashboard" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] lg:text-5xl font-bold mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18"
            initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Architect Software That Adapts To Your Business In Real Time
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left"
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves builds resilient platforms tailored to your workflows. From discovery to launch, we ensure every release is measurable, secure, and primed for scale.
          </motion.p>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Pair bespoke software with web platforms, mobile apps, secure infrastructure, and scalable delivery teams.
              </p>
            </div>
          </div>
