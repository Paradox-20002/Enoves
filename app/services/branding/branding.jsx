  ...
  const featureSections = [
    {
      ...
      image: {
        src: "/images/branding_images/brand2.jpg",
        alt: "Brand strategy collaboration",
      },
    ...
    },
    {
      ...
      image: {
        src: "/images/branding_images/brand4.webp",
  ...
  const exploreServices = [
    {
      ...
      description:
        "Campaign-ready visuals produced with brand fidelity and speed.",
    ...
    },
    {
      ...
      description:
        "Experience design that keeps shipping velocity aligned with vision.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Lifecycle journeys that extend your refreshed identity across touchpoints.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Growth programs that deliver your new brand to priority audiences.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/branding_images/brand6.gif"
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          <motion.h1
            className="text-4xl mb-2 lg:pl-32 mt-12 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:mt-10 lg:pr-[300px] text-center lg:text-left"
            initial={ { opacity: 0, y: 10 } }
            animate={ { opacity: 1, y: 0 } }
          ...
          >
            Enoves guides your team from insight to identity, ensuring
            campaigns, product experiences, and enablement materials all carry
