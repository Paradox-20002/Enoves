...
import { brandingFaqs } from "./branding-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Define the story, promise, and positioning that anchors every interaction. We align founders, marketers, and sellers around unified messaging that builds trust and accelerates preference.",
      highlights: [
        { label: "Positioning Platforms", color: "bg-pink-400" },
        { label: "Audience Narratives", color: "bg-fuchsia-400", delay: "0.3s" },
        { label: "Messaging Playbooks", color: "bg-rose-400", delay: "0.6s" },
      ],
      image: { src: "/images/branding_images/brand2.jpg", alt: "Brand strategy collaboration" },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Identity Systems",
      description:
        "Translate strategy into visual languages that scale. From core marks to activation kits, we equip teams with flexible guidelines that keep campaigns cohesive across channels.",
      highlights: [
        { label: "Logo Systems", color: "bg-purple-400" },
        { label: "Visual Libraries", color: "bg-violet-400", delay: "0.3s" },
        { label: "Launch Toolkits", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: { src: "/images/branding_images/brand4.webp", alt: "Brand identity guidelines" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Palette className="w-6 h-6" />, title: "Graphics Design", href: "/services/graphics", description: "Campaign-ready visuals produced with brand fidelity and speed.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Sparkles className="w-6 h-6" />, title: "Product Design", href: "/services/product-design", description: "Experience design that keeps shipping velocity aligned with vision.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Email Marketing", href: "/services/email-marketing", description: "Lifecycle journeys that extend your refreshed identity across touchpoints.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Digital Marketing", href: "/services/digital-marketing", description: "Growth programs that deliver your new brand to priority audiences.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/branding_images/brand6.gif" alt="Branding workshop" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] lg:text-5xl font-bold mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Build Brands That Feel Consistent Everywhere
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves guides your team from insight to identity, ensuring campaigns, product experiences, and enablement materials all carry the same unmistakable voice.
          </motion.p>
