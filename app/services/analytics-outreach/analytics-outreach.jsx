...
import { analyticsOutreachFaqs } from "./analytics-outreach-content";
...
export default function AnalyticsOutreach() {
  const featureSections = [
    {
      title: "Attribution & Instrumentation",
      description:
        "Repair tracking gaps and connect journeys end-to-end. We implement server-side events, UTM governance, and platform integrations so data is trustworthy from click to close.",
      highlights: [
        { label: "Tracking Audits", color: "bg-sky-400" },
        { label: "Attribution Models", color: "bg-cyan-400", delay: "0.3s" },
        { label: "Data Pipelines", color: "bg-blue-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/analytics_images/analytics.jpg",
    ...
    },
    {
      ...
      description:
        "Turn analytics into ongoing optimisation. We build dashboards, facilitate reviews, and embed analysts with channel leads to translate findings into experiments and pivots.",
      highlights: [
        { label: "Operational Dashboards", color: "bg-purple-400" },
        { label: "Performance Rituals", color: "bg-violet-400", delay: "0.3s" },
        { label: "Experiment Loops", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/analytics_images/analytics1.jpg",
  ...
  const exploreServices = [
    {
      ...
      description:
        "Ground decisions in unified visibility across every channel.",
    ...
    },
    {
      ...
      description:
        "Feed lifecycle programmes with audiences built on reliable data.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Optimise spend with attribution that reflects true performance.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Carry insights back to creative and community teams instantly.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/analytics_images/analytics2.jpg"
            alt="Analytics review"
            fill
            priority
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          <motion.p
            className="max-w-2xl lg:pl-32 text-gray-200 pr-0 text-center  lg:text-left lg:pr-20 sm:text-center"
            initial={ { opacity: 0 } }
            animate={ { opacity: 1 } }
            transition={ { duration: 0.6, delay: 0.1 } }
          >
            Enoves transforms fragmented reporting into real-time intelligence,
            embedding analysts who close the loop between data, strategy, and
            execution.
          </motion.p>
      ...
      <FaqSection faqs={ analyticsOutreachFaqs } />
    </main>
  );
}
