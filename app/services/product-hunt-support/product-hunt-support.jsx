...
import { productHuntFaqs } from "./product-hunt-content";
import FaqSection from "../../components/faq/faq";
import Image from "next/image";
import CTASection from "../../components/home/CTASection";

export default function ProductHuntSupport() {
  const featureSections = [
    {
      title: "Launch Playbooks",
      description:
        "Architect every step of your Product Hunt debut. We define positioning, teaser sequences, and supporter outreach so launch day builds momentum early.",
      highlights: [
        { label: "Narrative Framing", color: "bg-orange-400" },
        { label: "Community Seeding", color: "bg-amber-400", delay: "0.3s" },
        { label: "Asset Production", color: "bg-yellow-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/product-hunt_images/product-hunt1.jpg",
        alt: "Product Hunt launch planning",
      },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Launch-Day Command",
      description:
        "Coordinate real-time engagement from the first upvote. We manage response scripts, influencer activation, and analytics tracking to keep momentum peaking.",
      highlights: [
        { label: "Live Moderation", color: "bg-purple-400" },
        { label: "Supporter Activation", color: "bg-violet-400", delay: "0.3s" },
        { label: "Performance Dashboards", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/product-hunt_images/product-hunt2.jpg",
        alt: "Team monitoring Product Hunt launch",
      },
  ...
  const exploreServices = [
    {
      ...
      href: "/services/saas",
      description: "Translate launch feedback into your product roadmap fast.",
    ...
    },
    {
      ...
      description: "Keep new signups engaged with onboarding and success cadences.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Amplify launch learnings across your broader growth plan.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Produce standout visuals for Product Hunt and beyond.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/product-hunt_images/product-hunt3.jpg"
            alt="Product Hunt launch dashboard"
            fill
            priority
        ...
        <div className="relative z-30 max-w-3xl">
          ...
          >
            Launch On Product Hunt With Confidence And Clarity
          </motion.h1>
          <motion.p
          ...
          >
            Enoves guides your team through every stage of a Product Hunt launch, ensuring the story, assets, and community engagement deliver lasting growth.
          </motion.p>
      ...
      {/* FAQ */}
      <FaqSection faqs={productHuntFaqs} />
    </main>
  );
}
