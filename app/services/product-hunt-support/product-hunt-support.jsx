...
export default function ProductHuntSupport() {
  ...
  const exploreServices = [
    ...
    },
    {
      ...
      description:
        "Keep new signups engaged with onboarding and success cadences.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
    ...
    >
      ...
      >
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          >
            Enoves guides your team through every stage of a Product Hunt
            launch, ensuring the story, assets, and community engagement deliver
            lasting growth.
          </motion.p>
