  ...
  const featureSections = [
    {
      ...
      description:
        "Plan and execute precise LinkedIn outreach campaigns to engage your target audience. Our team crafts personalized messages and connection sequences that spark meaningful conversations and drive lead growth efficiently.",
      highlights: [
        { label: "Targeted Connections", color: "bg-green-400" },
        {
          label: "Personalized Messaging",
          color: "bg-teal-400",
          delay: "0.3s",
        },
        { label: "Lead Nurturing", color: "bg-emerald-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/linkedin_images/linkedin2.jpg",
        alt: "Connection Strategy",
      },
    ...
    },
    {
      ...
      description:
        "Track and analyze LinkedIn interactions to continuously improve outreach results. Our approach uses insights to adjust messaging, timing, and targeting, ensuring higher response rates and sustained audience engagement.",
      highlights: [
        { label: "Message Analytics", color: "bg-blue-400" },
        { label: "Campaign Timing", color: "bg-purple-400", delay: "0.3s" },
        { label: "Response Tracking", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/linkedin_images/linkedin3.webp",
        alt: "Engagement Optimization",
      },
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/linkedin_images/linkedin1.jpeg"
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          <motion.h1
            className="text-4xl text-center lg:text-left mb-2 mt-12 lg:pl-32 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:mt-10 lg:pr-[300px]"
            initial={ { opacity: 0, y: 10 } }
            animate={ { opacity: 1, y: 0 } }
