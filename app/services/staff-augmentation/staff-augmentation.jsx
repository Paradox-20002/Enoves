    ...
    >
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1
            className="text-3xl font-bold md:text-[2.75rem] lg:text-5xl mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18"
        ...
        <div className="relative flex flex-col gap-12 md:h-[720px]">
          {featureSections.map((feature, index) => (
            ...
            >
              ...
              <p className="text-gray-300 text-base md:text-[15px] lg:text-lg leading-relaxed">
                {feature.description}
              </p>
              {index === 0 && (
