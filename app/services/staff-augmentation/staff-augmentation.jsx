...
import { Sparkles, Users, Settings2, Rocket } from "lucide-react";
import { motion } from "framer-motion";
import { staffAugmentationFaqs } from "./staff-augmentation-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Integrate senior engineers, designers, and product leaders into your rituals. We synchronise standups, reviews, and tooling so velocity ramps without disruption.",
      highlights: [
        { label: "Rapid Onboarding", color: "bg-orange-400" },
        { label: "Shared Tooling", color: "bg-amber-400", delay: "0.3s" },
        { label: "Delivery Metrics", color: "bg-yellow-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/staff-augmentation_images/staff1.png",
        alt: "Product team collaborating in standup",
      },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Elastic Expertise",
      description:
        "Access specialised talent across cloud, mobile, data, and growth. We scale squads in weeks, maintain knowledge continuity, and taper support when objectives are met.",
      highlights: [
        { label: "Global Coverage", color: "bg-purple-400" },
        { label: "Specialist Pods", color: "bg-violet-400", delay: "0.3s" },
        { label: "Enablement Plans", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/staff-augmentation_images/staff2.png",
        alt: "Remote experts collaborating over video call",
      },
  ...
  const exploreServices = [
    {
      ...
      description: "Pair augmented talent with full-stack delivery squads.",
    ...
    },
    {
      ...
      description: "Boost mobile teams with senior engineers and PMs.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Keep bespoke platforms moving with specialist pods.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description: "Mobilise launch crews that activate your community fast.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/staff-augmentation_images/staff3.png"
            alt="Augmented team working together in office"
            fill
            priority
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          <motion.h1
            className="text-4xl mb-2 mt-12 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text lg:pl-32 text-transparent digital-hero-title lg:mt-10 lg:pr-[300px] text-center lg:text-left"
            initial={ { opacity: 0, y: 10 } }
            animate={ { opacity: 1, y: 0 } }
            transition={ { duration: 0.6 } }
          >
            Expand your delivery capacity with embedded experts
          </motion.h1>
          ...
          >
            Enoves supplies product-ready talent who plug into your teams,
            uphold standards, and keep roadmaps moving while you focus on
      ...
      >
        <h1 className="text-2xl md:text-3xl text-white font-extrabold">
          Keep momentum with on-demand talent partners
        </h1>
        <p className="text-gray-300 text-base md:text-lg mb-12 max-w-2xl mt-4">
          Whether you need to close skill gaps, accelerate a roadmap, or launch
          a new initiative, our embedded experts bring structure, velocity, and
          measurable outcomes.
        </p>
        <Link href="/contact">
          <motion.button
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Combine augmented teams with product strategy, engineering, and
                launch support tailored to your roadmap.
              </p>
            </div>
          </div>
      ...
      <FaqSection faqs={ staffAugmentationFaqs } />
    </main>
  );
}
