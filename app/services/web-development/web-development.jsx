  ...
  const featureSections = [
    {
      ...
      image: { src: "/images/webdev_images/web1.jpg", alt: "Designers collaborating on a web architecture map" },
    ...
    },
    {
      ...
      image: { src: "/images/webdev_images/web2.jpg", alt: "Developers reviewing deployment dashboards" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Sparkles className="w-6 h-6" />, title: "App Development", href: "/services/app-development", description: "Extend experiences with native and cross-platform apps.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Code className="w-6 h-6" />, title: "Custom Software", href: "/services/custom-software-development", description: "Engineer bespoke platforms that unlock new capability.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Smartphone className="w-6 h-6" />, title: "SaaS Product Development", href: "/services/saas", description: "Scale product squads that evolve your SaaS footprint.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Users className="w-6 h-6" />, title: "Staff Augmentation", href: "/services/staff-augmentation", description: "Embed senior talent to accelerate your delivery teams.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/webdev_images/web3.jpg" alt="Modern web application interface" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          ...
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves partners with digital teams to launch fast, responsive, and secure web products. From architecture to optimisation, we deliver lasting impact.
          </motion.p>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm md:text-base text-gray-300">
                Extend your engineering capacity with complementary product, mobile, and growth capabilities.
              </p>
            </div>
          </div>
