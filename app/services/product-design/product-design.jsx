  ...
  const featureSections = [
    {
      ...
      image: { src: "/images/product_images/product1.jpg", alt: "Product discovery workshop" },
    ...
    },
    {
      ...
      image: { src: "/images/product_images/product2.jpg", alt: "Product design handoff" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Palette className="w-6 h-6" />, title: "UI/UX Design", href: "/services/uiux", description: "Research-fuelled experiences that keep interfaces intuitive.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Sparkles className="w-6 h-6" />, title: "Branding", href: "/services/branding", description: "Identity systems that carry through every product surface.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Email Marketing", href: "/services/email-marketing", description: "Lifecycle journeys that extend product value post-launch.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Digital Marketing", href: "/services/digital-marketing", description: "Growth plays that amplify new feature adoption.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/product_images/product3.jpg" alt="Product design collaboration" fill priority className="object-cover object-center" sizes="100vw"/>
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          ...
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves embeds product designers that bridge discovery and delivery, keeping teams aligned and features validated from ideation through release.
          </motion.p>
