  ...
  const featureSections = [
    {
      ...
      image: {
        src: "/images/prepost_images/prepost1.jpg",
        alt: "Pre-launch enablement",
      },
    ...
    },
    {
      ...
      image: {
        src: "/images/prepost_images/prepost2.jpg",
        alt: "Customer success workshop",
      },
  ...
  const exploreServices = [
    {
      ...
      href: "/services/saas",
      description:
        "Connect product evolution with the programmes that support it.",
    ...
    },
    {
      ...
      description:
        "Reinforce trust with governance that supports customer retention.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Align success messaging with the rest of your growth engine.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
