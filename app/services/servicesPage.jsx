...
export default function ServicesPage() {
  return (
    <main className="flex flex-col gap-24 px-6  py-20 pb-24 bg-[#0a0a0d] text-[#f7f8ff]" style={{background: 'radial-gradient(circle at top right, rgba(105, 97, 255, 0.12), transparent 55%), #0a0a0d'}}>
      ...
      <section className="grid gap-12 mx-6 lg:mx-30 grid-cols-1 lg:grid-cols-2 items-center">
        <div>
          ...
          <h1 className="my-4 text-4xl sm:text-5xl lg:text-6xl leading-tight">Digital solutions engineered for ambitious brands</h1>
          <p className="text-lg sm:text-xl text-[#d7d8f8] max-w-[620px]">
        ...
        <div className="flex justify-center">
          <div className="w-60 sm:w-72 lg:w-80 aspect-square rounded-[36px] flex items-center justify-center shadow-[0_30px_60px_rgba(19,15,64,0.45)]" style={{background: 'linear-gradient(145deg, rgba(255, 255, 255, 0.12), rgba(105, 97, 255, 0.08))'}}>
            <Image
              src="/Enoves.svg"
              alt="Enoves"
              width={280}
      ...
      <section className="mx-6 lg:mx-30">
        <header className="max-w-[670px] flex flex-col gap-4">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl m-0">Revolutionizing the Way You Think Digital</h2>
      ...
      <section className="mx-6 lg:mx-30">
        <header className="max-w-[670px] flex flex-col gap-4">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl m-0">Why Enoves</h2>
          <p className="text-[#c6c8f4] text-base sm:text-lg">
