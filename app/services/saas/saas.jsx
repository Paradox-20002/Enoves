  ...
  const featureSections = [
    {
      ...
      image: {
        src: "/images/saas_images/saas4.jpg",
    ...
    },
    {
      ...
      image: {
        src: "/images/saas_images/saas2.jpg",
        alt: "Product delivery collaboration",
      },
  ...
  const exploreServices = [
    {
      ...
      description:
        "Enable customers before and after launch with proactive programmes.",
    ...
    },
    {
      ...
      description:
        "Coordinate high-impact launches that convert trial users into fans.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Build trust with the governance and controls modern buyers expect.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
    {
      ...
      description:
        "Layer human-centred UX on top of resilient SaaS foundations.",
      accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent",
    },
  ];
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/saas_images/saas3.jpg"
            alt="SaaS product planning"
            fill
            priority
        ...
        <div className="relative z-30 max-w-4xl pb-16">
          ...
          >
            Enoves pairs strategists, designers, and technologists to move your
            SaaS roadmap from hypothesis to reliable releases without
