...
import { saasFaqs } from "./saas-content";
  ...
  const featureSections = [
    {
      ...
      description:
        "Validate opportunities before committing engineering cycles. We gather customer insight, map journeys, and prototype experiences so your roadmap stays rooted in evidence.",
      highlights: [
        { label: "User Interviews", color: "bg-indigo-400" },
        { label: "Problem Framing", color: "bg-violet-400", delay: "0.3s" },
        { label: "Prototype Validation", color: "bg-purple-400", delay: "0.6s" },
      ],
      image: { src: "/images/saas_images/saas4.jpg", alt: "Product discovery workshop" },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Delivery Acceleration",
      description:
        "Ship cohesive product increments on schedule. We establish design systems, collaborate with engineering, and run QA loops that keep releases polished and predictable.",
      highlights: [
        { label: "Design Systems", color: "bg-blue-400" },
        { label: "Sprint Rituals", color: "bg-sky-400", delay: "0.3s" },
        { label: "Release QA", color: "bg-cyan-400", delay: "0.6s" },
      ],
      image: { src: "/images/saas_images/saas2.jpg", alt: "Product delivery collaboration" },
      articleClassName: "md:ml-auto md:mt-auto md:max-w-[48%] md:pl-10",
    },
  ];

  const exploreServices = [
    { icon: <Sparkles className="w-6 h-6" />, title: "Pre & Post Support", href: "/services/pre-post-support", description: "Enable customers before and after launch with proactive programmes.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Mail className="w-6 h-6" />, title: "Product Hunt Support", href: "/services/product-hunt-support", description: "Coordinate high-impact launches that convert trial users into fans.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Search className="w-6 h-6" />, title: "Data Security & Compliance", href: "/services/data-security-compliance", description: "Build trust with the governance and controls modern buyers expect.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
    { icon: <Palette className="w-6 h-6" />, title: "Product Design", href: "/services/product-design", description: "Layer human-centred UX on top of resilient SaaS foundations.", accent: "from-purple-400/60 via-fuchsia-500/30 to-transparent" },
  ];
    ...
    <main className="min-h-screen flex flex-col gap-16 pb-16 px-4 lg:px-2 md:px-8" style={{ fontFamily: "Arial, Helvetica, sans-serif", background: "radial-gradient(circle at top right, rgba(126,108,255,0.18), transparent 60%), radial-gradient(circle at bottom left, rgba(51,183,255,0.12), transparent 55%), #0a0a0d" }}>
      ...
      <section className="relative h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[90vh] xl:h-[90vh] text-white overflow-hidden flex flex-col justify-center gap-8 rounded-b-[48px] md:rounded-b-[72px]">
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image src="/images/saas_images/saas3.jpg" alt="SaaS product planning" fill priority className="object-cover object-center" sizes="100vw" />
        </div>
        ...
        <div className="relative z-30 max-w-3xl">
          <motion.h1 className="text-3xl md:text-[2.75rem] lg:text-5xl font-bold mb-2 text-center lg:text-left mt-12 lg:mt-10 bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent digital-hero-title lg:pl-18" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            Build SaaS Products That Ship Faster And Scale Smarter
          </motion.h1>
          <motion.p className="max-w-xl md:max-w-lg lg:max-w-2xl px-5 lg:pl-18 text-sm md:text-[15px] lg:text-base text-gray-200 pr-0 text-center lg:text-left" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.1 }}>
            Enoves pairs strategists, designers, and technologists to move your SaaS roadmap from hypothesis to reliable releases without sacrificing customer experience.
          </motion.p>
