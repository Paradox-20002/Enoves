...
import { uiuxfaqs } from "./uiux-content";
  ...
  const featureSections = [
    {
      title: "User Research",
      description:
        "Conduct in-depth user research to uncover behaviors, needs, and pain points. Our team transforms insights into actionable design strategies that enhance usability, engagement, and overall product experience.",
      highlights: [
        { label: "User Interviews", color: "bg-green-400" },
        { label: "Persona Creation", color: "bg-teal-400", delay: "0.3s" },
        { label: "Journey Mapping", color: "bg-emerald-400", delay: "0.6s" },
      ],
      image: { src: "/images/uiux_images/uiux1.jpg", alt: "User Research" },
      articleClassName: "md:max-w-[48%] md:pr-10",
    },
    {
      title: "Interaction Design",
      description:
        "Design intuitive interfaces and seamless interactions that delight users. We focus on wireframes, prototypes, and iterative testing to ensure every touchpoint is engaging, accessible, and aligned with business goals.",
      highlights: [
        { label: "Wireframing", color: "bg-blue-400" },
        { label: "Prototyping", color: "bg-purple-400", delay: "0.3s" },
        { label: "Usability Testing", color: "bg-indigo-400", delay: "0.6s" },
      ],
      image: {
        src: "/images/uiux_images/uiux2.jpg",
    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden rounded-b-[48px] md:rounded-b-[72px]">
          <Image
            src="/images/uiux_images/uiux3.jpg"
            alt="UI/UX hero background"
            fill
            priority
        ...
        <div className="relative z-30 max-w-2xl">
          ...
          >
            Enhance experiences across every interface
          </motion.h1>
          ...
          >
            Enoves crafts human-centered designs that guide users seamlessly
            through your product. From wireframes to interactive prototypes, our
            integrated squads create, test, optimise
          </motion.p>
