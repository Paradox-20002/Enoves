...
export default function Carousel({ img1, img2, img3, img4, className = "" }) {
  ...
  return (
    <section
      className={`relative w-full overflow-hidden py-16 ${className}`}
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, #05070E 0%, rgba(5,7,14,0) 100%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(270deg, #05070E 0%, rgba(5,7,14,0) 100%)",
        }}
      />
