...
const FaqSection = ( { faqs } ) => {
  ...
  return (
    <section className="mt-5 flex flex-col mx-5 lg:mx-0 gap-10 text-white">
      ...
      <div className="mx-auto flex w-full max-w-[900px] flex-wrap justify-between gap-6">
        { faqs.map( ( faq, index ) => (
          ...
          >
            <button
              className={ `flex w-full items-center justify-between gap-4 px-7 py-6 text-left text-base font-semibold text-white transition-colors duration-300 md:text-lg ${ openFaqIndex === index
                ? "text-[#8b5cf6]"
                : "hover:text-[#8b5cf6]"
                }` }
            ...
            >
              ...
              <span
                className={ `flex h-7 w-7 items-center justify-center text-[0.75rem] text-[#8b5cf6] transition-transform duration-300 ${ openFaqIndex === index ? "rotate-180" : "rotate-0"
                  }` }
              >
            ...
            <div
              className={ `max-h-0 overflow-hidden bg-[rgba(89,86,233,0.05)] px-7 transition-[max-height,padding] duration-300 ease-out ${ openFaqIndex === index ? "max-h-[160px] pb-6" : "pb-0"
                }` }
            >
